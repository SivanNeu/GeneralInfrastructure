...
inputData = pd.read_csv('../logs/input20250817_123745.csv')
controlLogData = pd.read_csv('../logs/control_logs20250817_123748.csv')
...
accl_ned_x = inputData['accl_ned_x'];accl_ned_y = inputData['accl_ned_y'];accl_ned_z = inputData['accl_ned_z']        
gyro_ned_x = inputData['gyro_ned_x'];gyro_ned_y = inputData['gyro_ned_y'];gyro_ned_z = inputData['gyro_ned_z']
pos_ned_ts = np.array(inputData['pos_ned_ts'])
pos_ned_x = inputData['pos_ned_x'];pos_ned_y = inputData['pos_ned_y'];pos_ned_z = inputData['pos_ned_z']
vel_ned_x = inputData['vel_ned_x'];vel_ned_y = inputData['vel_ned_y'];vel_ned_z = inputData['vel_ned_z']
quat_bodyfrd_cam_x = inputData['quat_bodyfrd_cam_x'];quat_bodyfrd_cam_y = inputData['quat_bodyfrd_cam_y'];quat_bodyfrd_cam_z = inputData['quat_bodyfrd_cam_z'];quat_bodyfrd_cam_w = inputData['quat_bodyfrd_cam_w']
quat_ts = np.array(inputData['quat_ned_bodyfrd_ts'])
quat_ned_bodyfrd_x = inputData['quat_ned_bodyfrd_x'];quat_ned_bodyfrd_y = inputData['quat_ned_bodyfrd_y'];quat_ned_bodyfrd_z = inputData['quat_ned_bodyfrd_z'];quat_ned_bodyfrd_w = inputData['quat_ned_bodyfrd_w']
current_ts = np.array(inputData['current_ts']); step_dt = inputData['step_dt']
lla_ts = np.array(inputData['lla_ts'])
lla_lat = inputData['lla_lat_deg'];lla_lon = inputData['lla_lon_deg'];lla_alt = inputData['lla_alt']
current_alt = inputData['current_alt']; 
command = inputData['command']
rpy_rate_cmd_x = inputData['rpy_rate_cmd_x'];rpy_rate_cmd_y = inputData['rpy_rate_cmd_y'];rpy_rate_cmd_z = inputData['rpy_rate_cmd_z']
quat_ned_desbodyfrd_cmd_x = inputData["quat_ned_desbodyfrd_cmd_x"];quat_ned_desbodyfrd_cmd_y = inputData["quat_ned_desbodyfrd_cmd_y"];quat_ned_desbodyfrd_cmd_z = inputData["quat_ned_desbodyfrd_cmd_z"];quat_ned_desbodyfrd_cmd_w = inputData["quat_ned_desbodyfrd_cmd_w"]
prev_los_ned_dir_x = inputData['prev_los_ned_dir_x'];prev_los_ned_dir_y = inputData['prev_los_ned_dir_y'];prev_los_ned_dir_z = inputData['prev_los_ned_dir_z']
camera_ned_x = inputData['camera_ned_x'];camera_ned_y = inputData['camera_ned_y'];camera_ned_z = inputData['camera_ned_z']
target_ned_x = inputData['target_ned_x'];target_ned_y = inputData['target_ned_y'];target_ned_z = inputData['target_ned_z']
image_size_px_x = inputData['image_size_px_x']; image_size_px_y = inputData['image_size_px_y']
quat_ned_desbodyfrd_cmd_x = inputData['quat_ned_desbodyfrd_cmd_x'];quat_ned_desbodyfrd_cmd_y = inputData['quat_ned_desbodyfrd_cmd_y'];quat_ned_desbodyfrd_cmd_z = inputData['quat_ned_desbodyfrd_cmd_z'];quat_ned_desbodyfrd_cmd_w = inputData['quat_ned_desbodyfrd_cmd_w']
prev_los_ned_dir_x = inputData['prev_los_ned_dir_x'];prev_los_ned_dir_y = inputData['prev_los_ned_dir_y'];prev_los_ned_dir_z = inputData['prev_los_ned_dir_z']
image_fov_vec_x = inputData['image_fov_vec_x']; image_fov_vec_y = inputData['image_fov_vec_y']
counter = inputData['counter']
modeID = np.array(inputData['modeID'])
timestamp = np.array(inputData['timestamp'])


los_ned_dir_x = controlLogData['los_ned_dir_x'];los_ned_dir_y = controlLogData['los_ned_dir_y'];los_ned_dir_z = controlLogData['los_ned_dir_z']
accel_cmd_ned_x = controlLogData['accel_cmd_ned_x'];accel_cmd_ned_y = controlLogData['accel_cmd_ned_y'];accel_cmd_ned_z = controlLogData['accel_cmd_ned_z']
vel_des_ned_x = controlLogData['vel_des_ned_x'];vel_des_ned_y = controlLogData['vel_des_ned_y'];vel_des_ned_z = controlLogData['vel_des_ned_z']
est_tar_pos_ned_x = controlLogData['est_tar_pos_ned_x'];est_tar_pos_ned_y = controlLogData['est_tar_pos_ned_y'];est_tar_pos_ned_z = controlLogData['est_tar_pos_ned_z']
roll_rate_cmd = controlLogData['roll_rate_cmd'];pitch_rate_cmd = controlLogData['pitch_rate_cmd'];yaw_rate_cmd = controlLogData['yaw_rate_cmd']
obs_tensor0 = np.array(controlLogData['obs_tensor[0]']); obs_tensor1 = np.array(controlLogData['obs_tensor[1]']); obs_tensor2 = np.array(controlLogData['obs_tensor[2]']); obs_tensor3 = np.array(controlLogData['obs_tensor[3]'])
obs_tensor = np.array([obs_tensor0, obs_tensor1, obs_tensor2, obs_tensor3])
