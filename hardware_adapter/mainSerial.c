...
void print_help(const char* program_name) {
    printf("Hardware Adapter (Serial) - MAVLink Serial Communication Bridge\n");
    printf("\n");
    ...
    printf("                      Format: serial:///dev/ttyS0:921600\n");
    printf("                      (default: serial:///dev/ttyS0:921600)\n");
    printf("\n");
    printf("Arguments:\n");
    ...
    printf("  the flight controller via MAVLink over a serial port.\n");
    printf("\n");
    printf("  Default MAVLink connection: serial:///dev/ttyS0:921600\n");
    printf("\n");
    ...
    printf("\n");
    printf("Examples:\n");
    printf("  %s                                    # Use defaults (../logs/, serial:///dev/ttyS0:921600)\n", program_name);
    printf("  %s ./logs                             # Use custom log directory\n", program_name);
    printf("  %s --address serial:///dev/ttyUSB0:57600  # Use different serial port and baudrate\n", program_name);
    printf("  %s --address serial:///dev/ttyS0:921600 ./logs  # Specify both address and log directory\n", program_name);
