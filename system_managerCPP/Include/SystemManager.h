...
#define DEFAULT_LOOP_PERIOD 0.03
#define DEFAULT_CURRENT_TIME -1.0
#define DEFAULT_DRONE_MASS 0.55
#define DEFAULT_YAW_COMMAND_FACTOR 1.0
#define DEFAULT_MAXIMAL_VELOCITY 0.75
#define DEFAULT_DESCENT_VELOCITY 10.0
#define DEFAULT_TARGET_VELOCITY 7.5
#define DEFAULT_CIRCLE_RADIUS 5.0
#define DEFAULT_WAYPOINT_REACH_THRESHOLD 0.5

// Default Vector3d components
#define DEFAULT_HEADING_DIR_NED_X -1.0
#define DEFAULT_HEADING_DIR_NED_Y 1.0
#define DEFAULT_HEADING_DIR_NED_Z 0.0

#define DEFAULT_DESIRED_HEADING_DIR_NED_X -1.0
#define DEFAULT_DESIRED_HEADING_DIR_NED_Y 1.0
#define DEFAULT_DESIRED_HEADING_DIR_NED_Z 0.0

// Default boolean values
#define DEFAULT_TERMINAL_HOMING_ALLOWED true
#define DEFAULT_RATE_CONTROL_ENABLED false
